  ...
  return (
    <div className="card flex flex-col gap-4 group">
      {project.image_url ? (
        ...
        <div className="w-full h-44 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/10 flex items-center justify-center">
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-gray-200/60 dark:border-gray-800/60">
        {project.github_url && (
          <a
